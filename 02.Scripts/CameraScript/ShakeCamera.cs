...
public class ShakeCamera : MonoBehaviour
{
    ...
    private CameraController cameraController;          // CameraController 인스턴스 생성
    ...
    private void Awake()
    {
        cameraController = GetComponent<CameraController>();    // CameraController 컴포넌트 참조
    }
